...
- 기간: 2023년 4월~
- 정기 회의: 미정
- 참고 사이트: [코드업](https://codeup.kr/index.php), [프로그래머스](https://programmers.co.kr/learn/challenges), [백준](https://www.acmicpc.net/)
- 언어: 파이썬
...
1) 리뷰 시간 가지기(이해)
2) 50% 이상 끝내고 백준 class2 or 프로그래머스 레벨1
3) 새미 프로젝트(모바일 청첩장?) - 자바
...
- 파일명 : `문제번호_Codeup`
- 커밋메세지 : [범위]문제 <br> ex) `[기초-출력] 6001-6015` 
   **<i>중괄호기준으로 커밋하기</i>
